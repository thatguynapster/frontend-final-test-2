...
const InfoBar = ({}: Props) => {
  return (
    <div className={classNames("fixed z-30 left-0 right-0 top-0")}>
      <div className="relative px-5 py-4 bg-light dark:bg-dark flex gap-4 items-center justify-between border-b border-[#B4B4B4]">
        <Image
          src={"/img/logo.png"}
          alt={"FEFT Logo"}
          width={50}
